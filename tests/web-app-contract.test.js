...
t(/\.details-play-orb\s*\{[\s\S]*?width\s*:\s*70px[\s\S]*?linear-gradient\(145deg[\s\S]*?#057/.test(html), 'movie hero Play control keeps the compact dark-teal outer reference treatment');
